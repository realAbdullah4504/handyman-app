	...
	html: `
            ...
            <body>
              <div class="container">
                ...
                <p class="desc">Have you forgotten your password. Don't worry, we're here to help!</p>
            
                <p class="desc">Click the following link to reset your password:</p>
                <a
                ...
                <p class="desc1">Temporary password: ${password}</p>

                <p class="desc1">If you have any questions or need assistance, we are here to help.</p>
                </br>
