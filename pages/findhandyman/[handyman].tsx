      ...
      <Head>
        <title className="capitalize">
          {`Encuentra ${changeServiceFormat(
            handyman
          )} Verificados en ${changeServiceFormat(city)}`}
        </title>
        <meta
          name="description"
      ...
      <div className="pt-32 bg-mainBackground">
        <section className="Container space-y-10 text-center mb-10">
          ...
          <p className="w-full lg:w-1/2 text-gray-600 text-left font-medium mx-auto">
            ...
            tus necesidades de {changeServiceFormat(handyman)}. Obtén servicios
            de {changeServiceFormat(handyman)} confiables y de alta calidad con
            facilidad.
          </p>
        </section>
