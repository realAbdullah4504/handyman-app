          ...
          <div className="pt-32 bg-mainBackground">
            <section className="Container space-y-10 text-center mb-10">
              <h1 className="text-3xl capitalize md:text-4xl font-bold">
                ...
                <span className="text-orange">{city}</span> - Obtén ofertas
                gratis{" "}
              </h1>
              <p className="w-full lg:w-1/2 text-gray-600 text-left font-medium mx-auto">
                ...
                nuestro servicio, puedes encontrar rápidamente y de forma
                gratuita {changeServiceFormat(handyman)} verificados en tu área.
                Compara las opiniones de otros clientes y elige al profesional
                adecuado para tus {changeServiceFormat(handyman)} necesidades.
              </p>
            </section>
