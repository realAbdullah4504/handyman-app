...
const ReformarHabitacionCosto = () => {
  return (
    <div className="container mx-auto p-4">
      <Head>
        <title>¿Cuánto cuesta reformar una habitación? - Oficios24</title>
        <meta
          name="description"
          content="Descubre los costos típicos asociados con la reforma de una habitación para mejorar tu hogar con un presupuesto limitado."
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_BASE_URL}/cuanto-cuesta/cuanto-cuesta-reformar-habitacion`}
        />
      </Head>

      <h1 className="text-3xl font-bold text-center mb-8">¿Cuánto cuesta reformar una habitación?</h1>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Consejos para reformar una habitación</h2>
      ...
      <section>
        <p className="text-lg">
          Con una planificación cuidadosa y la selección inteligente de materiales y servicios, puedes reformar tu habitación con éxito dentro de tu presupuesto.
        </p>
      </section>
    </div>
  );
...
export default ReformarHabitacionCosto;
