...
const CuantoCuestaReformarTerraza = () => {
  return (
    <div className="container mx-auto p-4">
      <Head>
        <title>¿Cuánto cuesta reformar una terraza? - Oficios24</title>
        <meta
          name="description"
          content="Descubre los costos típicos asociados con la reforma de una terraza para mejorar tu espacio exterior con un presupuesto limitado."
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_BASE_URL}/cuanto-cuesta/cuanto-cuesta-reformar-terraza`}
        />
      </Head>

      <h1 className="text-3xl font-bold text-center mb-8">¿Cuánto cuesta reformar una terraza?</h1>

      <section className="mb-8">
        <div className="flex flex-wrap justify-center">
          <div className="bg-green-500 text-white p-4 rounded-md shadow-md mx-4 mb-4 md:w-1/3 text-center">
            <p className="text-xl font-bold mb-2">Reforma básica: €50 - €100 por metro cuadrado</p>
            <p>Incluye cambios simples como limpieza y pequeñas reparaciones.</p>
          </div>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside">
          <li>Dimensiones y diseño de la terraza.</li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Consejos para reformar una terraza</h2>
      ...
      <section>
        <p className="text-lg">
          Con una planificación cuidadosa y la selección inteligente de materiales y servicios, puedes reformar tu terraza con éxito dentro de tu presupuesto.
        </p>
      </section>
    </div>
  );
...
export default CuantoCuestaReformarTerraza;
