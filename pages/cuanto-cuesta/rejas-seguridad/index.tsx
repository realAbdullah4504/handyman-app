...
const RejasSeguridadPage = () => {
  return (
    <div className="container mx-auto p-4">
      <Head>
        <title>¿Cuánto cuesta instalar rejas de seguridad? - Oficios24</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_BASE_URL}/cuanto-cuesta/rejas-seguridad`}
        />
      </Head>
...
export default RejasSeguridadPage;