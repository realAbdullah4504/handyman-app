...
const ConstruccionCasasCoste = () => {
  return (
    <div className="container mx-auto p-4">
      <Head>
        <title>¿Cuánto cuesta la construcción de una casa? - Oficios24</title>
        <meta
          name="description"
          content="Descubre los costes asociados con la construcción de casas y cómo presupuestar para tu proyecto de construcción de vivienda."
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_BASE_URL}/cuanto-cuesta/cuanto-cuesta-construccion-casas`}
        />
      </Head>

      <h1 className="text-3xl font-bold text-center mb-8">¿Cuánto cuesta la construcción de una casa?</h1>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Precios promedio para la construcción de casas</h2>
        <ul className="list-disc list-inside">
          <li>
      ...
      <section className="mb-8">
        ...
        <p>1. <strong>Evaluar las necesidades del proyecto</strong>: Determinar el tamaño y la complejidad del proyecto de construcción de la casa.</p>
      ...
      <section>
        <p className="text-lg">
          Al planificar la construcción de tu casa, ten en cuenta estos factores para asegurar un proyecto exitoso dentro de tu presupuesto.
        </p>
      </section>
    </div>
  );
...
export default ConstruccionCasasCoste;
