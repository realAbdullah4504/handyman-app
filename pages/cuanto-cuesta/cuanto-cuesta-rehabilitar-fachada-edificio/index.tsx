...
const RehabilitarFachadaEdificioCoste = () => {
  return (
    <div className="container mx-auto p-4">
      <Head>
        <title>¿Cuánto cuesta rehabilitar la fachada de un edificio? - Oficios24</title>
        <meta
          name="description"
          content="Descubre los costes asociados con la rehabilitación de la fachada de un edificio y cómo planificar y presupuestar este tipo de trabajo."
        />
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_BASE_URL}/cuanto-cuesta/cuanto-cuesta-rehabilitar-fachada-edificio`}
        />
      </Head>

      <h1 className="text-3xl font-bold text-center mb-8">¿Cuánto cuesta rehabilitar la fachada de un edificio?</h1>
      ...
      <section>
        <p className="text-lg">
          Al comprender los factores que influyen en los costos de la rehabilitación de fachadas y planificar adecuadamente, puedes gestionar el proyecto de manera eficiente y dentro de tu presupuesto.
        </p>
      </section>
    </div>
  );
...
export default RehabilitarFachadaEdificioCoste;