...
export default function Profile({
  ...
  <>
    <Head>
      <title>
        {`Perfil de ${profile} en ${address} - Servicios de Reparación de Calidad`}
      </title>
      <meta
        name="description"
        content={`¿Buscas un reparador confiable? Descubre el perfil de ${profile} en ${address}. Lee reseñas, conoce sus servicios y contacta directamente. ¡Tu satisfacción es la prioridad de ${profile}!`}
      />
      {/* Descripción corta más efectiva para SEO */}
