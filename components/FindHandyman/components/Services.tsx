...
export default function Services({
  ...
  return (
    <div className="w-full">
      <section className="text-center space-y-2 flex flex-wrap items-end justify-between">
        <span className="font-bold flex gap-2 text-xl ">
          Buscar Reparador
          <p className="font-bold text-orange">Perfiles</p>
        </span>
        <span>
          <h1 className="text-3xl font-bold text-black">Nuestros Servicios</h1>
          <p className="text-xl font-medium">Construimos para tu Comodidad</p>
        </span>
        <span></span>
      </section>
