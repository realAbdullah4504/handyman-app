...
const NotificationBar = ({
	...
	const notificationBarClass = `absolute h-[400px] right-0 top-7 transition-all duration-300 ${
				...
				<div className={notificationBarClass}>
					<div
						...
						{hasNextPage && isFetchingNextPage && (
							<b className="block text-center">Loading...</b>
						)}
						{data?.pages[0]?.data?.length === 0 && (
							<b className="block text-center">No notification</b>
						)}
					</div>
				</div>
			}
