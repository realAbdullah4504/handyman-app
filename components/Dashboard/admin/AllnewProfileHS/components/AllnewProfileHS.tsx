      ...
      <div className="w-full overflow-x-scroll">
        <div className="w-[90rem] lg:w-full">
          <div className="flex justify-center items-center bg-[#F0EAEA] py-3 pl-7 rounded-t-md">
            <span className="font-bold w-[10rem]">Image</span>
            <span className="font-bold w-[10rem]">Name</span>
            <span className="font-bold w-[10rem]">Company name</span>
            <span className="font-bold w-[10rem]">Email</span>
            <span className="font-bold w-[10rem]">IP address</span>
            <span className="font-bold w-[12rem]">Registration date</span>
            <span className="font-bold w-[10rem] text-center">
              Uploaded documents
            </span>
            <span className="font-bold w-[10rem]">Verified</span>
            <span className="font-bold w-[10rem]">Un verified</span>
            <span className="font-bold w-[7rem]">Activate</span>
          </div>
