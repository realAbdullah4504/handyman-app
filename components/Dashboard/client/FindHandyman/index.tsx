	...
	return (
		<div className={`w-full my-12`}>
			<h1 className=" text-3xl font-bold">
				Receive free <span className="text-orange">handyman offer</span>{" "}
			</h1>
			<h2 className="ml-2 text-center mt-20 font-bold text-2xl md:text-3xl mb-2">
				Select the appropriate service for your job:{" "}
			</h2>
