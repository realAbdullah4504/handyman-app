...
export default function Page6({
	...
	const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		console.log("Email ", value, 'CD ', contactDetailsPage.email, 'isnext? ', isNextBtnDisable, "useMultiStepForm ", setIsLastStep)
	...
	return (
		<section className="m-2 mx-5 mb-6 mt-5  md:mx-10 lg:mx-20">
			<h2 className="mb-5 mt-1 font-semibold">Enter Email</h2>
