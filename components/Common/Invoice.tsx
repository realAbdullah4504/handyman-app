			...
			<div className="">
				<div className="flex justify-between mb-8">
					...
					<div className="space-y-2">
						...
						<div className="flex items-center">
							<span className="block w-1/2 font-bold">Date</span>
							<span className="block w-1/2">
				...
				<div className="bg-gray-800 text-white flex mb-6 p-2 rounded-t">
					<div className="w-1/2 p-2">Item Description</div>
					<div className="w-1/6 p-2 text-right">Qyt</div>
					<div className="w-1/6 p-2 text-right">Rate</div>
					<div className="w-1/6 p-2 text-right">Amount</div>
				</div>
				...
				<div className="mb-4">
					<span className="block w-full mb-2 font-bold">Notes</span>
					<span className="block w-full">
