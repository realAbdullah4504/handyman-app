	...
	html: `<html>
            ...
            <body>
              <div class="container">
                ...
                <p class="desc">Your Craftman profile has been successfully created. To activate your account and access the full features, please click on the following registration link</p>
                ...
                <p class="desc">Please keep your login details secure and do not share them with others. After activation, you can use this information to log in to Handyman service Portal.</p>
