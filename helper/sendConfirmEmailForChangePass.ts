...
export const sendChangePassMail = (
	...
	to: `${user.email}`,
	subject: `Confirmation: Password Change Successful`,
	html: `
            <html>
            <head>
              <style>
            ...
            <body>
              <div class="container">
                ...
                <p class="desc">Your password has been successfully changed. Please confirm this change by clicking on the following link</p>
